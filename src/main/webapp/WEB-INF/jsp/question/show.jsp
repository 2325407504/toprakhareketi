...
<div class="bs-docs-example" data-content="<spring:message code="Questions"></spring:message>">
	...
	<spring:url var="question_status" value="/question/status/${questionAttribute.id}" />
	...
	<aripd:description id="questions">
		<aripd:descriptionitem label="Username" field="${questionAttribute.account.username}"></aripd:descriptionitem>
	...
	<spring:url var="answer_save" value="/answer/save/question/${questionAttribute.id}" />
